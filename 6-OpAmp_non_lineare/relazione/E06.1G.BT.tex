...
\begin{document}
	...
	\section{Multivibratore astabile}
		...
		\subsection{Teoria Multivibratore astabile}
			Il multivibratore astabile è quello in figura \ref{fig:multivibratore}, esso è un trigger di Schmitt con due diodi zener che limitano $-V_{br}<V_{out}<V_{br}$, dove $V_{br}$ è il voltaggio di breakdown dei zener. Inoltre $V_-$, grazie al condensatore si carica dello stesso segno di $V_{out}$, ciò crea un fenomeno oscillatorio.
			\begin{figure}
